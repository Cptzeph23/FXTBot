...
from fxtbot.configuration.deprecated_settings import process_temporary_deprecated_settings
from fxtbot.configuration.directory_operations import create_datadir, create_userdata_dir
from fxtbot.configuration.environment_vars import enironment_vars_to_dict
from fxtbot.configuration.load_config import load_file, load_from_files
...
from fxtbot.misc import deep_merge_dicts, parse_db_uri_for_logging, safe_value_fallback
...
class Configuration:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        from fxtbot.commands.arguments import NO_CONF_ALLOWED
