...
from fxtbot.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from fxtbot.data.converter import populate_dataframe_with_trades
from fxtbot.data.converter.converter import reduce_dataframe_footprint
...
from fxtbot.exceptions import OperationalException, StrategyError
from fxtbot.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from fxtbot.misc import remove_entry_exit_signals
from fxtbot.persistence import Order, PairLocks, Trade
from fxtbot.strategy.hyper import HyperStrategyMixin
from fxtbot.strategy.informative_decorator import (
    InformativeData,
    PopulateIndicators,
...
from fxtbot.util import dt_now
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for fxtbot strategies
    ...
    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            ...
            from fxtbot.freqai.utils import download_all_data_for_training
            from fxtbot.resolvers.freqaimodel_resolver import FreqaiModelResolver
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by fxtbot itself, but intended to be used if users lock pairs
