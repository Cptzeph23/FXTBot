...
from fxtbot.enums import CandleType, MarginMode, PriceType, TradingMode
from fxtbot.exceptions import DDosProtection, OperationalException, TemporaryError
from fxtbot.exchange import Exchange
from fxtbot.exchange.binance_public_data import (
    concat_safe,
    download_archive_ohlcv,
    download_archive_trades,
)
from fxtbot.exchange.common import retrier
from fxtbot.exchange.exchange_types import FtHas, Tickers
from fxtbot.exchange.exchange_utils_timeframe import timeframe_to_msecs
from fxtbot.misc import deep_merge_dicts, json_load
from fxtbot.util.datetime_helpers import dt_from_ts, dt_ts
        ...
        try:
            if self.trading_mode == TradingMode.FUTURES and not self._config["dry_run"]:
                ...
                if position_side.get("dualSidePosition") is True:
                    msg += (
                        "\nHedge Mode is not supported by fxtbot. "
                ...
                if (
                    ...
                    msg += (
                        "\nMulti-Asset Mode is not supported by fxtbot. "
