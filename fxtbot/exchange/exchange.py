...
from fxtbot.data.converter import (
...
from fxtbot.exchange.exchange_types import (
    CcxtBalances,
    CcxtOrder,
    CcxtPosition,
    FtHas,
...
from fxtbot.util import dt_from_ts, dt_now
from fxtbot.util.datetime_helpers import dt_humanize_delta, dt_ts, format_ms_time
...
class Exchange:
    ...
    def validate_trading_mode_and_margin_mode(
        ...
        """
        Checks if fxtbot can perform trades using the configured
        trading mode(Margin, Futures) and MarginMode(Cross, Isolated)
        Throws OperationalException:
            If the trading_mode/margin_mode type are not supported by fxtbot on this exchange
        """
    ...
    def fetch_dry_run_order(self, order_id) -> CcxtOrder:
        ...
        try:
            ...
            from fxtbot.persistence import Order
