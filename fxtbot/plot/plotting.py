...
from fxtbot.data.history import get_timerange, load_data
...
from fxtbot.exchange import timeframe_to_prev_date, timeframe_to_seconds
from fxtbot.misc import pair_to_filename
...
from fxtbot.util import get_dry_run_wallet
...
def generate_plot_filename(pair: str, timeframe: str) -> str:
    ...
    file_name = "fxtbot-plot-" + pair_s + "-" + timeframe + ".html"
...
def plot_profit(config: Config) -> None:
    ...
    store_plot_file(
        fig,
        filename="fxtbot-profit-plot.html",
        directory=config["user_data_dir"] / "plot",
