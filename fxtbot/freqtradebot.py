...
from fxtbot.configuration import validate_config_consistency
from fxtbot.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from fxtbot.data.converter import order_book_to_dataframe
from fxtbot.data.dataprovider import DataProvider
from fxtbot.edge import Edge
...
from fxtbot.exchange.exchange_types import CcxtOrder
from fxtbot.leverage.liquidation_price import update_liquidation_prices
from fxtbot.misc import safe_value_fallback, safe_value_fallback2
from fxtbot.mixins import LoggingMixin
from fxtbot.persistence import Order, PairLocks, Trade, init_db
from fxtbot.persistence.key_value_store import set_startup_time
...
from fxtbot.rpc.external_message_consumer import ExternalMessageConsumer
from fxtbot.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from fxtbot.util import FtPrecise, MeasureTime, PeriodicCache, dt_from_ts, dt_now
from fxtbot.util.migrations.binance_mig import migrate_binance_futures_names
...
class FreqtradeBot(LoggingMixin):
    ...
    def process(self) -> None:
        ...
        # Without this, fxtbot may try to recreate stoploss_on_exchange orders
