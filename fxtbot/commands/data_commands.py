...
from fxtbot.constants import DATETIME_PRINT_FORMAT, DL_DATA_TIMEFRAMES, Config
from fxtbot.enums import CandleType, RunMode, TradingMode
from fxtbot.exceptions import ConfigurationError
from fxtbot.plugins.pairlist.pairlist_helpers import dynamic_expand_pairlist
...
def start_download_data(args: dict[str, Any]) -> None:
    ...
    from fxtbot.data.history import download_data_main
...
def start_convert_trades(args: dict[str, Any]) -> None:
    from fxtbot.configuration import TimeRange, setup_utils_configuration
    from fxtbot.data.converter import convert_trades_to_ohlcv
...
def start_convert_data(args: dict[str, Any], ohlcv: bool = True) -> None:
    ...
    """
    from fxtbot.configuration import setup_utils_configuration
    from fxtbot.data.converter import convert_ohlcv_format, convert_trades_format
...
def start_list_data(args: dict[str, Any]) -> None:
    ...
    from fxtbot.util import print_rich_table
...
def start_list_trades_data(args: dict[str, Any]) -> None:
    ...
    """
    from fxtbot.configuration import setup_utils_configuration
    from fxtbot.misc import plural
    from fxtbot.util import print_rich_table
