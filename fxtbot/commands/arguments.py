...
from fxtbot.commands.cli_options import AVAILABLE_CLI_OPTIONS
from fxtbot.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="fxtbot", description="Free, open source crypto trading bot"
        )
