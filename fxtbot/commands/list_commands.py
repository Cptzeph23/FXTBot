...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    from fxtbot.exchange import list_available_exchanges
    from fxtbot.ft_types import ValidExchangesType
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from fxtbot.configuration import setup_utils_configuration
    from fxtbot.exchange import market_is_active
    from fxtbot.misc import plural, safe_value_fallback
    from fxtbot.resolvers import ExchangeResolver
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from fxtbot.configuration import setup_utils_configuration
    from fxtbot.misc import parse_db_uri_for_logging
