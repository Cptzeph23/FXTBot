...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from fxtbot.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting fxtbot in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from fxtbot.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting fxtbot in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of fxtbot Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help fxtbot to exit
...
def start_edge(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting fxtbot in Edge mode")
...
def start_lookahead_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from fxtbot.configuration import setup_utils_configuration
    from fxtbot.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
