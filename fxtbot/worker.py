...
from fxtbot.constants import PROCESS_THROTTLE_SECS, RETRY_TIMEOUT, Config
from fxtbot.enums import RPCMessageType, State
from fxtbot.exceptions import OperationalException, TemporaryError
from fxtbot.exchange import timeframe_to_next_date
...
class Worker:
    ...
    def _reconfigure(self) -> None:
        ...
        # Clean up current fxtbot modules
