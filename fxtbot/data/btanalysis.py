...
from fxtbot.constants import LAST_BT_RESULT_FN, IntOrInf
from fxtbot.exceptions import ConfigurationError, OperationalException
from fxtbot.ft_types import BacktestHistoryEntryType, BacktestResultType
from fxtbot.misc import file_dump_json, json_load
from fxtbot.optimize.backtest_caching import get_backtest_metadata_filename
from fxtbot.persistence import LocalTrade, Trade, init_db
...
def analyze_trade_parallelism(results: pd.DataFrame, timeframe: str) -> pd.DataFrame:
    ...
    """
    from fxtbot.exchange import timeframe_to_resample_freq
