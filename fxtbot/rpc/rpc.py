...
from fxtbot.constants import CANCEL_REASON, DEFAULT_DATAFRAME_COLUMNS, Config
from fxtbot.data.history import load_data
from fxtbot.data.metrics import DrawDownResult, calculate_expectancy, calculate_max_drawdown
...
from fxtbot.exceptions import ExchangeError, PricingError
from fxtbot.exchange import Exchange, timeframe_to_minutes, timeframe_to_msecs
from fxtbot.exchange.exchange_utils import price_to_precision
from fxtbot.loggers import bufferHandler
from fxtbot.persistence import CustomDataWrapper, KeyStoreKeys, KeyValueStore, PairLocks, Trade
from fxtbot.persistence.models import PairLock
from fxtbot.plugins.pairlist.pairlist_helpers import expand_pairlist
from fxtbot.rpc.fiat_convert import CryptoToFiatConverter
from fxtbot.rpc.rpc_types import RPCSendMsg
...
from fxtbot.wallets import PositionWallet, Wallet
...
class RPC:
    ...
    def __init__(self, freqtrade) -> None:
        ...
        :param freqtrade: Instance of a fxtbot bot
        :return: None
        """
    ...
    def _rpc_show_config(
        ...
        val = {
            ...
            "bot_name": config.get("bot_name", "fxtbot"),
    ...
    def _rpc_get_logs(limit: int | None) -> dict[str, Any]:
        ...
        #       "fxtbot.worker", "INFO", "Starting worker develop"]
    ...
    def _rpc_analysed_history_full(
        ...
        from fxtbot.data.converter import trim_dataframe
