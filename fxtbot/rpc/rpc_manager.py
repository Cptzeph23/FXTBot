...
from fxtbot.enums import NO_ECHO_MESSAGES, RPCMessageType
from fxtbot.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, freqtrade) -> None:
        ...
        if config.get("telegram", {}).get("enabled", False):
            ...
            from fxtbot.rpc.telegram import Telegram
        ...
        if config.get("discord", {}).get("enabled", False):
            ...
            from fxtbot.rpc.discord import Discord
        ...
        if config.get("webhook", {}).get("enabled", False):
            ...
            from fxtbot.rpc.webhook import Webhook
