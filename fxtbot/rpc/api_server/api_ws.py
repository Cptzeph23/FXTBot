...
from fxtbot.enums import RPCMessageType, RPCRequestType
from fxtbot.exceptions import FreqtradeException
from fxtbot.rpc.api_server.api_auth import validate_ws_token
from fxtbot.rpc.api_server.deps import get_message_stream, get_rpc
from fxtbot.rpc.api_server.ws.channel import WebSocketChannel, create_channel
from fxtbot.rpc.api_server.ws.message_stream import MessageStream
from fxtbot.rpc.api_server.ws_schemas import (
    WSAnalyzedDFMessage,
    WSErrorMessage,
    WSMessageSchema,
    WSRequestSchema,
