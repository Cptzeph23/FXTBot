...
from fxtbot.persistence import FtNoDBContext
from fxtbot.rpc.api_server.api_pairlists import handleExchangePayload
from fxtbot.rpc.api_server.api_schemas import BgJobStarted, DownloadDataPayload
from fxtbot.rpc.api_server.deps import get_config, get_exchange
from fxtbot.rpc.api_server.webserver_bgwork import ApiBG
from fxtbot.util.progress_tracker import get_progress_tracker
...
def __run_download(job_id: str, config_loc: Config):
    try:
        ...
        from fxtbot.data.history.history_utils import download_data
