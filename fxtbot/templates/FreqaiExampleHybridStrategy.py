...
from fxtbot.strategy import IntParameter, IStrategy, merge_informative_pair  # noqa
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    fxtbot trade --strategy FreqaiExampleHybridStrategy --strategy-path fxtbot/templates
