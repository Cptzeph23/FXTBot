...
import fxtbot.exchange as exchanges
from fxtbot.constants import Config, ExchangeConfig
from fxtbot.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in fxtbot.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("fxtbot.", ""),
                    }
                )
        return result
