...
from fxtbot.constants import FTHYPT_FILEVERSION
from fxtbot.exceptions import OperationalException
from fxtbot.optimize.hyperopt_tools import HyperoptTools, hyperopt_serializer
...
def test_try_export_params(default_conf, tmp_path, caplog, mocker):
    ...
    default_conf["user_data_dir"] = tmp_path
    export_mock = mocker.patch("fxtbot.optimize.hyperopt_tools.HyperoptTools.export_params")
